...
class ComentariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post comentarios_url, params: { comentario: { articulo_id: @comentario.articulo_id, nombre: @comentario.nombre, texto: @comentario.texto } }
    end
  ...
  test "should update comentario" do
    patch comentario_url(@comentario), params: { comentario: { articulo_id: @comentario.articulo_id, nombre: @comentario.nombre, texto: @comentario.texto } }
